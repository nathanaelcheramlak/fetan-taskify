import { CustomError } from "api/types/ErrorType";
import { RequestType } from "api/types/RequestType";
import { NextFunction, Response } from "express";
import type {
  SignupRequestBody,
  LoginRequestBody,
  UserPayload,
} from "api/types/RequestType";
import User from "api/models/user.model";
import bcrypt from "bcryptjs";
import { clearJWT, setJWT } from "api/utils/JWT";
